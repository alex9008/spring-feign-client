package com.example.feign.client.demofeignclient.webflux.service;

import com.example.feign.client.demofeignclient.webflux.entity.User;
import com.example.feign.client.demofeignclient.webflux.repository.UserRepository;
...
public class UserService {
    ...
    public Mono<User> deleteUser(String userId) {
        return userRepository.findById(userId).flatMap(existingUser -> userRepository.delete(existingUser).then(Mono.just(existingUser)));
    }
